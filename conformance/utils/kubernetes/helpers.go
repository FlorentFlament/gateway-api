...
func parentsMatch(t *testing.T, expected, actual []v1alpha2.RouteParentStatus, namespaceRequired bool) bool {
	...
	oneParentMatchClosed := func(t *testing.T, eParent, aParent v1alpha2.RouteParentStatus) bool {
...
func oneParentMatch(t *testing.T, eParent, aParent v1alpha2.RouteParentStatus, namespaceRequired bool) bool {
...
func oneListenerMatch(t *testing.T, eListener, aListener v1alpha2.ListenerStatus) bool {
